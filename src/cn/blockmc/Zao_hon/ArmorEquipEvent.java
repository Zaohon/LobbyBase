...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable {
	...
	public enum EquipMethod {// These have got to be the worst documentations
								// ever.
		/**
		...
		PICK_DROP,
		/**
		 * When you right click an armor piece in the hotbar without the
		 * inventory open to equip.
		 */
		HOTBAR,
		/**
		 * When you press the hotbar slot number while hovering over the armor
